...
ciclo:
		...
		FMUL    V3.4S, V3.4S, V4.4S //v3 = a1*d1 ; -b1*c1 ; a2*d2 ; -b2*c2    MULTIPLICA PELA GLOBAL VSIGN
		FADDP	V5.4S, V5.4S, V3.4S //v5 = a1*c1 -b1*d1 ; a2*c2 - b2*d2 ; a1*d1 - b1*c1 ; a2*d2 - b2*c2
		MOV		W5, V5.S[2]			//aux = a2*c2 - b2*d2
		INS		V5.S[2], V5.S[1]   //v5 = a1*c1 -b1*d1 ; a1*d1 - b1*c1 ; a1*d1 - b1*c1 ; a2*d2 - b2*c2
		MOV		V5.S[1], W5			//V5 = a1*c1 -b1*d1 ; a1*d1 - b1*c1 ; a2*c2 - b2*d2 ; a2*d2 - b2*c2
		STR		Q5, [X2], #16		//guarda vetor
		SUB		X3, X3, #1			//proximos 4 elementos
		B ciclo
